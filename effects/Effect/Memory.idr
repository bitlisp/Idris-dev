...
do_memset ptr offset c size
  = mkForeign (FFun "idris_memset" [FPtr, FInt ITNative, FInt IT8, FInt ITNative] FUnit)
...
do_poke ptr offset (b::bs)
  = do mkForeign (FFun "idris_poke" [FPtr, FInt ITNative, FInt IT8] FUnit) ptr (cast offset) b
